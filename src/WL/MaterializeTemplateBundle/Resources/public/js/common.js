$(document).ready(function() {
    ...
    $("#category-view-list").click(function() {
        ...
        $(".product-wrapper-grid").removeClass('col l4 m6 s12 product-wrapper-grid').addClass('col l12 product-wrapper-list');
        replaceUrl('list');
    });
    $("#category-view-grid").click(function() {
        $(this).addClass('active');
        $("#category-view-list").removeClass('active');
        $(".product-wrapper-list").removeClass('col l12 product-wrapper-list').addClass('col l4 m6 s12 product-wrapper-grid');
        replaceUrl('box');
    });
